...
class CollabFilterOneVectorPerItem(AbstractBaseCollabFilterSGD):
    ...
    def predict(self, user_id_N, item_id_N,
        ...
        # Calculate the dot product for all pairs
    ...
    def calc_loss_wrt_parameter_dict(self, param_dict, data_tuple):
        ...
        regularization_term = self.alpha * (ag_np.sum(ag_np.square(self.param_dict['U'][data_tuple[0]])) + ag_np.sum(ag_np.square(param_dict['V'][data_tuple[1]])))
        
        #(ag_np.sum(ag_np.square(param_dict['U'][data_tuple[0]])) + ag_np.sum(ag_np.square(param_dict['V'][data_tuple[1]])))
        loss_total = regularization_term + ag_np.sum(ag_np.square(y_N-yhat_N))
        return loss_total    
...
if __name__ == '__main__':
    ...
    model = CollabFilterOneVectorPerItem(
        n_epochs=50, batch_size=32, step_size=0.2,
