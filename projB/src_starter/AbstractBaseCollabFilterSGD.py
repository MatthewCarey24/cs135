        ...
        for epoch_count in range(self.n_epochs): 
            ...
            for i, batch_tuple in enumerate(batch_loader):
                ...
                if do_report_now:
                    ...
                    print("epoch %11.3f | loss_total % 11.5f | train_AUC% 11.5f | valid_AUC % 11.5f | train_AUC% 11.5f | valid_AUC % 11.5f | %s" % (
                        epoch, loss if epoch <= 2 else smooth_loss,
                        train_perf_dict['auc'], valid_perf_dict['auc'], train_perf_dict['mae'], valid_perf_dict['mae'],
                        avg_grad_norm_str))
